...
export default class OperativesToSite extends Component {
  static navigationOptions = {
    headerTitle: 'Operatives on site'
  }
  ...
  render() {
    ...
    return (
      <Container>
          ...
          <Button disabled={!this.state.showButton} title='Add Operatives' onPress={() => {this.onAddPress()}} />
